...
export function ChatHeader({
  ...
  return (
    <header className="relative z-0 flex min-h-[90px] shrink-0 items-center justify-between rounded-[18px] border border-white/70 bg-[#D6E0FF]/60 px-10 py-4 shadow-[inset_0_2px_4px_rgba(255,255,255,0.65)]">
      <div className="flex min-w-0 items-center gap-4">
        ...
        <div className="min-w-0">
          <h2 className="truncate text-xl font-bold text-[#121212]">{title}</h2>
