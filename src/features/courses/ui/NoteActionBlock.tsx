...
export function NoteActionBlock({
  note,
  onNoteChange,
  itemAction,
  onItemActionChange,
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      <div
        style={{ display: "flex", gap: 16, alignItems: "flex-start", width: "100%", maxWidth: 880 }}
      >
        <div
          style={{
            flex: 1,
          ...
          {isEditing ? (
            <textarea
              ...
              style={{
                ...
                fontSize: 16,
                lineHeight: "20px",
                color: note ? "var(--color-text-primary)" : "var(--color-draft)",
              }}
            />
          ) : (
            <div
          ...
          {contentActions.map(({ key, label, color }) => {
            ...
            return (
              <button
                key={key}
                type="button"
                onClick={() => onItemActionChange(isActive ? null : key)}
                style={{
                  display: "flex",
                  flexDirection: "row",
                  justifyContent: "space-between",
                  ...
                  height: 23,
                  background: "white",
                  border: `1px solid ${isActive ? color : "var(--color-draft)"}`,
                  borderRadius: 20,
                  cursor: "pointer",
                  fontFamily: monoFont,
                  fontWeight: 500,
              ...
              >
                ...
                {key === "approved" && (
                  ...
                  <img
                    ...
                    width={16}
                    height={16}
                    style={{ width: 16, height: 16, opacity: isActive ? 1 : 0.35 }}
                  />
                )}
                {key === "rejected" && (
                  // eslint-disable-next-line @next/next/no-img-element
                ...
                {key === "needs_revision" && (
                  ...
                  <img
                    ...
                    width={14}
                    height={14}
                    style={{ width: 14, height: 14, opacity: isActive ? 1 : 0.35 }}
                  />
                )}
              </button>
            );
