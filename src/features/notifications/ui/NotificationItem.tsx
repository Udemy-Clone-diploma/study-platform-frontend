...
export function NotificationItem({
  ...
  return (
    <button
      ...
      className={`flex w-full items-start gap-4 rounded-3xl p-3 text-left transition-all duration-200 hover:-translate-y-0.5 hover:shadow-(--shadow-card) active:translate-y-0 ${
