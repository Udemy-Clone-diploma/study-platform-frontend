 ...
 */
export const PILL_BTN_MOBILE_CLASS = "max-lg:!h-[46px] max-lg:!min-w-[160px] max-lg:!text-base";
      ...
      {open && (
        <div
          style={{
            ...
            padding:
              "clamp(8px, 0.521vw, 10px) clamp(14px, 1.042vw, 20px) clamp(14px, 1.042vw, 20px)",
            display: "flex",
...
export function ProfileInstructionLanguageField({
  editing,
  value,
  inputValue,
  onInputChange,
}: ProfileInstructionLanguageFieldProps) {
  const t = useTranslations("ProfileFields");
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: FIELD_GAP }}>
