  ...
  return (
    <div className="flex h-dvh min-w-0 flex-col overflow-hidden bg-white lg:h-screen lg:min-w-[1024px]">
      ...
      <div className="relative flex flex-1 items-stretch overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-y-auto overflow-x-hidden pt-(--mobile-header-content-offset) pb-[calc(103px+env(safe-area-inset-bottom))] lg:pt-0 lg:pb-0">
